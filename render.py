...
colored_map = plot(
    ...
    layers = {
        ...
        drawing_kwargs = {
            ...
            'green_extra': {'fc': '#479e4c', 'ec': '#2F3737', 'hatch': 'OOO', 'hatch_c': '#4fb054', 'lw': 0, 'zorder': 1},
            'living': {'fc': '#F2F4CB', 'ec': '#2F3737', 'lw': 1, 'zorder': 1},
            'water_still': {'fc': '#a1e3ff', 'ec': '#2F3737', 'hatch': 'ooo...', 'hatch_c': '#85c9e6', 'lw': 1, 'zorder': 2},
...
ax.text(
    ...
    'Sinzenich, Zülpich',
    color = '#2F3737',
    fontproperties = fm.FontProperties(fname = 'assets/font/PermanentMarker-Regular.ttf', size = 35),
    in_layout = False
)

plt.savefig('prints/sinzenich.png')
plt.savefig('prints/sinzenich.svg')
#plt.savefig('../prints/sinzenich.jpg')